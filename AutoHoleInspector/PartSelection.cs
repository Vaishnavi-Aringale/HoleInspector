...
//
//       Filename:  D:\Vaishnavi\Solution_AutoHoleInspector\PartSelection.cs
//
...
public class PartSelection
{
    ...
    public PartSelection()
    {
        try
        {
            ...
            theUI = UI.GetUI();
            theDlxFileName = "PartSelection.dlx";
    ...
    public void initialize_cb()
    {
        try
        {
            selectPartID = (NXOpen.BlockStyler.Group)theDialog.TopBlock.FindBlock("selectPartID");
            componentSelectID = (NXOpen.BlockStyler.SelectObject)theDialog.TopBlock.FindBlock("componentSelectID");
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
    ...
    public int apply_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            SetSelectedComponentAsWorkPart();
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
    ...
    private void SetSelectedComponentAsWorkPart()
    {
        PropertyList props =
            theDialog.GetBlockProperties("componentSelectID");

        TaggedObject[] selected =
            props.GetTaggedObjectVector("SelectedObjects");

        if (selected == null || selected.Length == 0)
            throw new Exception("Please select a component from assembly.");

        Component comp = selected[0] as Component;

        if (comp == null)
            throw new Exception("Selected object is not a component.");
        ...
        theSession.Parts.SetWork(compPart);

        theUI.NXMessageBox.Show(
            "Part Selection",
            NXMessageBox.DialogType.Information,
            "Component set as Work Part:\n" + compPart.Name
        );
    }
